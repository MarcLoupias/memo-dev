...
- [Gérard Berry](https://fr.wikipedia.org/wiki/G%C3%A9rard_Berry)
  ...
  - [Le meilleur des mondes informatiques - 20180829](https://www.franceculture.fr/emissions/la-methode-scientifique/gerard-berry-le-meilleur-des-mondes-informatiques)
    ...
    - 3 formes de communications possible : asynchrone (internet par ex, on envoie un message on ne sait pas si il va arriver ni quand), synchrone (on envoie un message et on fait comme si il arrivait en temps zéro), vibratoire (envoie message qui arrive à une vitesse connue, par le GPS), c'est en étudiant comment programmer sur ces 3 paradigmes et en les faisant communiquer qu'ils ont développer Esterel.
